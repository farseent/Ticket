  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-2">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <input placeholder="Depart Time" value={form.departTime} onChange={update('departTime')} className={inputClass} />
        <input placeholder="Arrive Time" value={form.arriveTime} onChange={update('arriveTime')} className={inputClass} />
